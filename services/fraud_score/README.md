...
**Port:** `8001` | **Runtime:** Node.js / Express | **Type:** Atomic microservice
...
The score range is 0–100. Decision thresholds are applied by OutSystems in production, or by the local `detect_fraud` fallback during Docker development and automated testing.
...
| Retraining  | Run the training script and replace the model file                                                       |
