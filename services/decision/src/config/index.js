...
module.exports = {
  ...
  serviceName: process.env.SERVICE_NAME || 'decision',
  ...
  db: {
    ...
    database: process.env.DB_NAME || dbFromUrl.database || 'ftds_decision',
  ...
  kafka: {
    ...
    clientId: process.env.KAFKA_CLIENT_ID || 'decision',
